...
namespace FilmCollection
{
    public class FileRecord
    {
        ...
        public bool Equals(FileRecord rec)
        {
            if (rec is FileRecord && rec != null)
            {
                FileRecord temp;
                temp = (FileRecord)rec;
        ...
        public static int CompareByName(FileRecord a, FileRecord b)     // Сравнение по названию
        {
            return string.Compare(a.Name, b.Name);
        }

        public static int CompareByCatalog(FileRecord a, FileRecord b)  // Сравнение по каталогу
        {
        ...
        public static int CompareByGenre(FileRecord a, FileRecord b) // Сравнение по жанру
        {
            return string.Compare(a.GenreString, b.GenreString);
        }

        public static int CompareByCategory(FileRecord a, FileRecord b) // Сравнение по категории
        {
        ...
        public static int CompareByFileName(FileRecord a, FileRecord b) // Сравнение по файлу
        {
