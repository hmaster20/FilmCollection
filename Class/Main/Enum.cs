...
namespace FilmCollection
{
    ...
    class MyClass
    {
        void dic()
        {
            ...
            description.Add(12, "Драма (греч.drаmа, букв. - действие) - литературный и кинематографический жанр.Специфику жанра составляют сюжетность, конфликтность действия, обилие диалогов и монологов. Драмы изображают в основном частную жизнь человека и его острый конфликт с обществом.При этом акцент часто делается на общечеловеческих противоречиях, воплощённых в поведении и поступках конкретных персонажей.");
            description.Add(13, "Мелодрама (от греч. mеlоz - песня и драма) - жанр художественной литературы, театрального искусства и кинематографа, произведения которого раскрывают духовный и чувственный мир героев в особенно ярких эмоциональных ситуациях на основе контрастов: добро и зло, любовь и ненависть и т.п.");
            description.Add(14, "Триллер(от англ.thrill — трепет, волнение) — жанр произведений литературы и кино, нацеленный вызвать у зрителя или читателя внезапный прилив эмоций, чувство тревоги, возбуждение.");
            ...
            description.Add(16, "Исторический фильм – фильмы этого жанра киноискусства реконструируют реально происходившие исторические события.Исторические фильмы обычно бывают высокобюджетными, с красивыми костюмами и декорациями, нередко с внушительными массовками.");
            description.Add(17, "Прочие фильмы");
