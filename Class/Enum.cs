...
namespace FilmCollection
{
    ...
    class MyClass
    {
        void dic()
        {
            ...
            description.Add(15, "Исторический фильм – фильмы этого жанра киноискусства реконструируют реально происходившие исторические события.Исторические фильмы обычно бывают высокобюджетными, с красивыми костюмами и декорациями, нередко с внушительными массовками.");
